...
public class ConsoleApp
{
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        var availableItem = bookItems.FirstOrDefault(bi => loans?.All(l => l.BookItemId != bi.Id || l.ReturnDate != null) ?? true);
        ...
        {
            var currentLoan = loans?.FirstOrDefault(l => l.ReturnDate == null);
            if (currentLoan != null)
            {
